...
import C_MainScripts.MAUC as MAUC
import argparse
...
def evalOneSub(d4Df, forecastDf):
    ...
    forecastDf['Forecast Date'] = [datetime.strptime(x, '%Y-%m') for x in forecastDf[
        'Forecast Date']]  # considers every month estimate to be the actual first day 2017-01
